...
This repo archives the **source code** of Anthropic's Claude Code CLI. Contributions here are about **documentation, tooling, and exploration aids** — not modifying the original Claude Code source.
...
- **`src/` directory** — This is the original source code, preserved as-is. Don't modify it.
- The [`backup` branch](https://github.com/G1r1shCodes/claude-code/tree/backup) contains the unmodified original.
...
Open an issue or reach out to [aashuu ✦](https://www.x.com/G1r1shCodes).
